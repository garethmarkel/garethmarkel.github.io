...
Here, I use methods fromoptimization (binary quadratic programming) to create portfolios of lineups for daily fantasy hockey and baseball. A command line utility for the optimization part of this can be found at this [GitHub link](https://github.com/garethmarkel/mlb_dfs_optimizer).
